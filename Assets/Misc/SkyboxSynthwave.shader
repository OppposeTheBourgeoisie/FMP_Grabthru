Shader "Custom/SynthwaveSkybox"
{
    Properties
    {
        _GradientColor ("Gradient Base Color", Color) = (1, 0, 0.5, 1)
        _SkyTopColor ("Sky Top Color", Color) = (0, 0, 0, 1)
        _GlowIntensity ("Glow Intensity", Range(0, 2)) = 1.0
        _RingColor ("Ring Color", Color) = (1, 0.5, 1, 1)
        _RingSize ("Ring Size", Range(0.1, 0.5)) = 0.3
        _RingSharpness ("Ring Sharpness", Range(0, 10)) = 5
        _SunColor ("Sun Color", Color) = (1, 0.5, 0.2, 1)
